...
public:
    ...
    string get_username();
    virtual void request_trip(int origin_index, int destination_indexint, int user_index, vector<Trip> &trips, int &trips_num,double price);
    virtual void check_trips_accessability();
    virtual void check_costs_accessability();
...
public:
    ...
    virtual void request_trip(int origin_index, int destination_index, int user_index, vector<Trip> &trips, int &trips_num,double price);
    virtual void delete_trip(vector<Trip> &trips, int trip_index);
    virtual void check_costs_accessability() {}
};
